...
Libraries/iLLD/TC37A/Tricore/Port/Std/%.o: ../Libraries/iLLD/TC37A/Tricore/Port/Std/%.c Libraries/iLLD/TC37A/Tricore/Port/Std/subdir.mk
	...
	tricore-elf-gcc -std=c11 "@C:/users/mr_monopoly/AURIX-v1.10.6-workspace/basic_aurix_template/TriCore Debug (GCC)/AURIX_GCC_Compiler-Include_paths__-I_.opt" -O0 -g3 -gdwarf-3 -Wall -c -fmessage-length=0 -fno-common -fstrict-volatile-bitfields -fdata-sections -ffunction-sections -mtc162 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
